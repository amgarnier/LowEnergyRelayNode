...
# this is the advertiser scanner device model. It takes in the probability model. The proxied device and details are brought into the scanner as it is the keys that are used to decrypt and verify the received message.
